...
RUN micromamba create -y -n deeppbs python=3.11 && \
    ...
    micromamba run -n deeppbs pip install biopython==1.86 matplotlib==3.10.7 pandas==2.3.3 logomaker networkx pdb2pqr scikit-learn==1.7.2 scipy==1.16.3 seaborn freesasa && \
